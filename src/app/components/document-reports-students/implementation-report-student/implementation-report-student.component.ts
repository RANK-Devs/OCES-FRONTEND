    ...
    this.inputService
      ...
      .subscribe((response) => {
        ...
        if (this.proposalIntakes) {
          this.proposalIntakeDetails = this.proposalIntakes.filter(
            (item: any) => {
          ...
          this.event_project_title =
            this.proposalIntakeDetails[0].project_title;
          this.event_sponsor_department =
            this.proposalIntakeDetails[0].departments;
          this.event_venue = this.proposalIntakeDetails[0].target_area;
          this.event_beneficiaries =
            this.proposalIntakeDetails[0].target_beneficiary;
        }
      });
  }
  onCheck() {
      ...
      this.inputService
        ...
        .subscribe({
          next: (res) => {
            ...
            this.inputService
              .updateIntakeFormService(
                this.updateProposalIntakeDetailsForm.value
              )
              .subscribe((response) => {
                this.addData_pdf(
                  this.file,
